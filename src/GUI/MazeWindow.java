...
public class MazeWindow extends BasicWindow 
{
	...
	void initWidgets() 
	{
		...
		generateButton = new Button(m_shell, SWT.PUSH);
		generateButton.setText("Generate");
		generateButton.setLayoutData(new GridData(SWT.FILL, SWT.None, false, false, 1, 1));

		positionsComposite = new Composite(m_shell, SWT.BORDER_SOLID);
		...
		exitButton = new Button(m_shell, SWT.PUSH);
	...
	{
		m_shell.addListener(SWT.Close, listener);
	}
